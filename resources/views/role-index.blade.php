    ...
    <div class="px-2 px-md-4">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="{{ route('role-create') }}" class="text-decoration-none"><button class="nav-link">Add
                    Role</button></a>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="paid-tab" data-bs-toggle="tab" data-bs-target="#paid" type="button"
                    role="tab" aria-controls="paid" aria-selected="false">View Roles</button>
            </li>
        </ul>
                    ...
                    <table class="table" style="width: 100%">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-light" style="background-color: #515151">Role name
                                    </th>
                ...
                <div class="row px-3 pb-3 justify-content-end">
                    <div class="col-7 d-flex justify-content-end">
                        <div class="d-flex p-0 m-0">
                            <a class="text-decoration-none" href="{{ $roles->withQueryString()->previousPageUrl() }}">
                            ...
                            <a class="text-decoration-none" href="{{ $roles->withQueryString()->nextPageUrl() }}">
...
@section('footer')
    <script>
        ...
        function go() {
            ...
            const url = new URL("{{ url('/') }}/role-index");

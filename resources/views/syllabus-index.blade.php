    ...
    <div class="px-2 px-md-4">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="{{ route('syllabus-create') }}" class="text-decoration-none"><button class="nav-link">Add
                        New Syllabus</button></a>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="paid-tab" data-bs-toggle="tab" data-bs-target="#paid" type="button"
                    role="tab" aria-controls="paid" aria-selected="false">View Syllabus</button>
            </li>
        </ul>
                        ...
                        <tbody>
                            ...
                            @foreach ($syllabuses as $key => $syllabus)
                                <tr class="">
                                    ...
                                    <td><object data="{{ asset('images/photos/' . $syllabus->image) }}" width="100"
                                    ...
                                    <td class="text-nowrap">
                                        <div class="container-fluid d-flex">
                                            ...
                                            <a href=" {{ route('syllabus-edit', $syllabus) }}">

                                                <div class="btn blue_button sized"><i
                                                        class='bx bx-message-square-edit'></i>Edit
                                                </div>
                                            </a>
                                            <a class="mx-1" href="{{ route('syllabus-delete', $syllabus->id) }}">
                ...
                <div class="row px-3 pb-3 justify-content-end">
                    <div class="col-7 d-flex justify-content-end">
                        <div class="d-flex p-0 m-0">
                            <a class="text-decoration-none" href="{{ $syllabuses->withQueryString()->previousPageUrl() }}">
                            ...
                            <div
                                ...
                                {{ $syllabuses->currentPage() }}

                            </div>


                            <a class="text-decoration-none" href="{{ $syllabuses->withQueryString()->nextPageUrl() }}">

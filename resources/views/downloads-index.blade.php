    ...
    <div class="px-2 px-md-4">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="{{ route('download-create') }}" class="text-decoration-none"><button class="nav-link">Add
                        Downloads</button></a>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="paid-tab" data-bs-toggle="tab" data-bs-target="#paid" type="button"
                    role="tab" aria-controls="paid" aria-selected="false">View Downloads</button>
            </li>
        </ul>
                    ...
                    <table class="table" style="width: 100%">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-light" style="background-color: #515151">Type
                                </th>
                                <th scope="col" class="text-light" style="background-color: #515151">Category
                                </th>
                                <th scope="col" class="text-light" style="background-color: #515151">File
                                </th>
                        ...
                        <tbody>
                            ...
                            @foreach ($downloads as $key => $download)
                                <tr class="">
                                    ...
                                    <td><object data="{{ asset('images/downloads/' . $download->file) }}" width="100"
                                            height="100"></object>
                                    </td>
                                    ...
                                    <td>
                                        <div class="container-fluid d-flex">
                                            ...
                                            <a href="{{ route('download-edit', $download) }}">
                                                <div class="btn blue_button sized"><i
                                                        class='bx bx-message-square-edit'></i>Edit
                                                </div>
                                            </a>
                ...
                <div class="row px-3 pb-3 justify-content-end">
                    <div class="col-7 d-flex justify-content-end">
                        <div class="d-flex p-0 m-0">
                            <a class="text-decoration-none" href="{{ $downloads->withQueryString()->previousPageUrl() }}">
                            ...
                            <a class="text-decoration-none" href="{{ $downloads->withQueryString()->nextPageUrl() }}">
...
@section('footer')
    <script>
        ...
        function go() {
            ...
            const url = new URL("{{ url('/') }}/download-index");

        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="unpaid-tab" data-bs-toggle="tab" data-bs-target="#unpaid" type="button"
                    role="tab" aria-controls="unpaid" aria-selected="true">Edit Post</button>
            </li>
                    ...
                    <form method="POST" action="{{ route('notice-update', $notice) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control" id="Currency-name"
                                placeholder=" Title" value="{{ old('title', $notice->title) }}">
                            @if ($errors->has('title'))
                        ...
                        <button type="submit" class="btn blue_button">Update Post</button>
                    </form>
                </div>
            </div>
        </div>

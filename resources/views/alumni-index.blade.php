    ...
    <div class="px-2 px-md-4">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="{{ route('alumni-create') }}" class="text-decoration-none"><button class="nav-link">Add
                        Alumni</button></a>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="paid-tab" data-bs-toggle="tab" data-bs-target="#paid" type="button"
                    role="tab" aria-controls="paid" aria-selected="false">View Alumni</button>
            </li>
        </ul>
                    ...
                    <table class="table" style="width: 100%">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-light" style="background-color: #515151">Designation
                                </th>
                                <th scope="col" class="text-light" style="background-color: #515151">Placement
                                </th>
                        ...
                        <tbody>
                            ...
                            @foreach ($alumnis as $key => $alumni)
                                <tr class="">
                                    ...
                                    <td>{{ $alumni->placement }}</td>
                                    <td>{!! $alumni->description !!}</td>
                                    <td>
                                        <object data="{{ asset('images/photos/' . $alumni->image) }}" width="100"
                                            height="100"></object>
                                    </td>
                                    ...
                                    <td class="text-nowrap">
                                        <div class="container-fluid d-flex">
                                            ...
                                            <a href="{{ route('alumni-edit', $alumni) }}">
                                                <div class="btn blue_button sized w-100"><i
                                                        class='bx bx-message-square-edit'></i>Edit
                                                </div>
                                            </a>
                                            <a href="{{ route('alumni-delete', $alumni->id) }}">
                                                <div class="btn btn-danger sized mx-2 "><i
                ...
                <div class="row px-3 pb-3 justify-content-end">
                    <div class="col-7 d-flex justify-content-end">
                        <div class="d-flex p-0 m-0">
                            <a class="text-decoration-none" href="{{ $alumnis->withQueryString()->previousPageUrl() }}">
                            ...
                            <a class="text-decoration-none" href="{{ $alumnis->withQueryString()->nextPageUrl() }}">

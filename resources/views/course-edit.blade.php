        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="unpaid-tab" data-bs-toggle="tab" data-bs-target="#unpaid" type="button"
                    role="tab" aria-controls="unpaid" aria-selected="true">Edit Course</button>
            </li>
                    ...
                    <form method="POST" action="{{ route('course-update', $course) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="duration" class="form-control" id="duration"
                                    placeholder=" Duration" value="{{ old('duration', $course->duration) }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <textarea id="introduction" name="introduction">{!! old('introduction', $course->introduction) !!}</textarea>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <textarea id="benefit" name="benefit">{!! old('benefit', $course->benefit) !!}</textarea>
                        ...
                        <button type="submit" class="btn blue_button">Update</button>
                    </form>
                </div>
            </div>
        </div>

        ...
        <div class="tab-content py-2 navsTabsShadow" id="myTabContent">
            ...
            <div class="tab-pane fade show  active" id="unpaid" role="tabpanel" aria-labelledby="unpaid-tab">
                <div class="container-fluid p-3">
                    <form method="POST" action="{{ route('setting-update', $settings) }}">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                ...
                                <input type="email" name="email" class="form-control" id="email"
                                    placeholder=" Duration" value="{{ old('email', $settings->email) }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-6">
                                ...
                                <input type="location" name="location" class="form-control" id="location"
                                    placeholder="Location" value="{{ old('location', $settings->location) }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-6">
                                ...
                                <input type="number" name="landline_number" class="form-control" id="landline_number"
                                    ...
                                    value="{{ old('landline_number', $settings->landline_number) }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-6">
                                ...
                                <input type="number" name="viber_number" class="form-control" id="viber_number"
                                    placeholder="viber_number"
                                    value="{{ old('viber_number', $settings->viber_number) }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-6">
                                ...
                                <input type="url" name="linkden_link" class="form-control" id="linkden_link"
                                    placeholder="linkden_link"
                                    value="{{ old('linkden_link', $settings->linkden_link) }}">
                            ...
                            <div class="col-6">
                                ...
                                <input type="date" name="establish_date" class="form-control" id="establish_date"
                                    placeholder="establish_date"
                                    value="{{ old('establish_date', $settings->establish_date) }}">
                        ...
                        <div class="col-6">
                            ...
                            <input type="number" name="numberof_student" class="form-control" id="numberof_student"
                                placeholder="numberof_student"
                                value="{{ old('numberof_student', $settings->numberof_student) }}">
                ...
                <button type="submit" class="btn blue_button " style="margin-left:14px;">Update Settings
                </button>
                </form>
            </div>
        </div>

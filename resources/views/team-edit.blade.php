        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="unpaid-tab" data-bs-toggle="tab" data-bs-target="#unpaid" type="button"
                    role="tab" aria-controls="unpaid" aria-selected="true">Edit Team Member</button>
            </li>
                    ...
                    <form method="POST" action="{{ route('team-update', $team) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" id="Currency-name"
                                placeholder="Full Name" value="{{ old('name', $team->name) }}">
                            @if ($errors->has('name'))
                        ...
                        <div class="row mb-3">
                            <div class="col-6">
                                ...
                                <input type="text" name="position" class="form-control" id="Currency-name"
                                    placeholder="Position " value="{{ old('position', $team->position) }}">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="category" class="form-control" id="Currency-name"
                                    placeholder="Representation " value="{{ old('category', $team->category) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                ...
                                <input type="number" name="sorting" class="form-control" id="Currency-name"
                                    placeholder="sorting order " value="{{ old('sorting', $team->sorting) }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="detail" class="form-control" id="Currency-name"
                                    placeholder=" Details " value="{{ old('detail', $team->detail) }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="form-check pb-3">
                                    <input class="form-check-input form-check" type="checkbox" name="status"
                                        {{ old('status', $team->status) == 1 ? 'checked' : '' }} value="1"
                                        id="status">
                        ...
                        <button type="submit" class="btn blue_button">Update Member</button>
                    </form>
                </div>
            </div>
        </div>
